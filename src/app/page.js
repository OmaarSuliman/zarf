...
import { AnimatedPillButton,AnimatedSquareButton, AnimatedGhostButton, AnimatedIconButton } from '../components/buttons';
      ...
      <footer className="bg-zinc-50 border-t border-zinc-200">
        <div className="max-w-7xl mx-auto py-12 px-6 sm:px-8">
            ...
            <div className="mt-8 pt-8 border-t border-zinc-200 text-center text-zinc-500 text-sm">
                <p>© {new Date().getFullYear()} Zarf Inc. All rights reserved.</p>
            </div>
        </div>
      </footer>
    </div>
